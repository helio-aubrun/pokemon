...
class Screen:
    def __init__(self):
        ...
        #fond d'ecran
        self.back = pygame.transform.scale( pygame.image.load ("image/field_bg.png"), (800, 600))
    ...
    def plateforme (self) :
        ...
        self.plat_joueur = pygame.image.load ("image/field_base0.png")

        #plateforme pokemon adverse
        self.plate_adv = pygame.image.load ("image/field_base1.png")
    ...
    def affich_joueur (self) :
        ...
        self.affiche_pkm_joueur = pygame.transform.scale (pygame.image.load ("image/" + str (self.pkm_joueur.id) + "/back.png"), (400, 400))
    ...
    def affiche_adv (self) :
        #chargement du sprite
        self.affich_pkm_adv = pygame.transform.scale (pygame.image.load ("image/" + str (self.pkm_adv.id) + "/front.png"), (400, 400))
    ...
    def affich_overlay (self) :
        #overlay
        self.overlay = pygame.transform.scale (pygame.image.load ("image/overlay_message.png"), (800,150))
        self.box = pygame.transform.scale (pygame.image.load ("image/overlay_fight1.png"), ((800 / 100) * 60, 100))
    ...
    def affich_overlay_vie_joueur (self) :
        #ovely
        overlay = pygame.transform.scale (pygame.image.load ("image/pkm_joueur_bare_vie.png"), (312, 111))
    ...
    def affich_overlay_vie_adversaire (self) :
        overlay = pygame.transform.scale (pygame.image.load ("image/overlay_bar_vie_adversaire.png"), (300, 87))
                        ...
                        if self.bt [i].collidepoint(mouse_pos):
                            ...
                            if self.pkm_joueur.pv <= 0:
                                ...
                                if not (self.test_fin_combat()) :
                                    ecran_chois = choix_pkm_joueur.changement ()
